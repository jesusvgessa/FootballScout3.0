        ...
        <article class="container bg-dark mb-5">
            <nav class="mb-3 container justify-content-center border-bottom">
                <ul class="row">
                    ...
                    <li class="col-auto">
                        <select class="filtroTabla" name="tema" id="tema">
                                    <option value="0">Ordenar</option>
                                    <option value="selectNombre">Nombre</option>
                                    <option value="selectDorsal">Dorsal</option>
                                    <option value="selectPosicion">Posición</option>
                                </select>
                    </li>
                    <li class="col-auto">
                    ...
                    <?php include_once "../php/databaseManagement.inc.php";
                        ...
                        if(sizeof(obtenerJugadoresEquipo(obtenerEntrenador($id_usuario)['id_equipo']))<25){
                            ...
                            echo "        <button class='anadirJugador'>Añadir jugador</button>";
                            echo "    </a>";
                            echo "</li>";
                        }//Fin si
                    ?>                    
            ...
            <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
                ...
                for ($i=0;$i<sizeof($listaJugadores);$i++){
                    ...
                    echo "            <img src='../img/".$listaJugadores[$i]['foto']."' alt='".$listaJugadores[$i]['apodo']."'>";
                    echo "            <div class='card-body'>";
                    echo "                <p class='nombre' id='nombre'>".$listaJugadores[$i]['nombre']." ".$listaJugadores[$i]['apellidos']."</p>";
                    echo "                <p class='num'>".$listaJugadores[$i]['dorsal']."</p>";
                    echo "                <p class='pos'>".$listaJugadores[$i]['pos']."</p>";
                    echo "                <button type='button' class='btn btn-sm btn-outline-secondary' data-bs-toggle='modal' data-bs-target='#".$listaJugadores[$i]['apodo']."'>";
                    echo "                    Ver perfil";
                    echo "                </button>";
                    //modal
